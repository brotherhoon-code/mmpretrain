...
from mmpretrain.models.backbones.custom_modules.SelfConv2d_1 import SelfConv2d
...
class SpatialMixBlock(nn.Module):
    def __init__(
        ...
        self.spatial_mix_layer = SelfConv2d(in_channels=dim, out_channels=dim, kernel_size=kernel_size, resolution=resolution)
        self.active_func = nn.GELU()
