...
# from mmcv.cnn.utils.weight import constant_init, kaiming_init
from ..builder import BACKBONES

'''
ref: https://github.com/dl19940602/GCnet-pytorch/blob/master/GCnet.py
'''
...
class CustomGCNet2(nn.Module):
    def __init__(self, 
                 block=BottleNeck, 
                 block1=ContextBlock2d, 
                 num_block=[3,4,6,3], 
                 num_classes=10, 
                 gc=True, 
                 deep_stem=True):
        ...
        self.conv1 = nn.Sequential(*self.stem)
        '''
