...
class SwinLikeDWResNet(nn.Module):
    def __init__(self, 
        ...
        self.stage1 = nn.Sequential(
            *[block(in_channels = stem_channels,
                    ...
                    stride = strides[0], 
                    act_func = act_func,
                    dw = dw[i]) for i in range(stage_blocks[0])]
            )
        self.stage2 = nn.Sequential(
            *[block(in_channels = stage_out_channels[0]*2,
                    ...
                    stride = strides[1],
                    act_func = act_func,
                    dw = dw[i]) for i in range(stage_blocks[1])]
            ) 
        self.stage3 = nn.Sequential(
            *[block(in_channels = stage_out_channels[1]*2,
                    ...
                    stride = strides[2],
                    act_func = act_func,
                    dw = dw[i]) for i in range(stage_blocks[2])]
            ) 
        self.stage4 = nn.Sequential(
            *[block(in_channels = stage_out_channels[2]*2,
                    ...
                    stride = strides[3],
                    act_func = act_func,
                    dw = dw[i]) for i in range(stage_blocks[3])]
            ) 
...
if __name__ == "__main__":
    m = SwinLikeDWResNet(dw = [False, True, False])
