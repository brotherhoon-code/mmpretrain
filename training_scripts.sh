...
# CONFIG_NAME02="config--swinlike_resnet-ddd"
# CONFIG_NAME03="config--swinlike_resnet-drr"
# CONFIG_NAME04="config--swinlike_resnet-rdr"
# CONFIG_NAME05="config--swinlike_resnet-rrd"
...
# CONFIG_FILE00=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME00}.py
# CONFIG_FILE01=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME01}.py
# CONFIG_FILE02=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME02}.py
# CONFIG_FILE03=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME03}.py
# CONFIG_FILE04=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME04}.py
# CONFIG_FILE05=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME05}.py
# CONFIG_FILE06=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME06}.py
# CONFIG_FILE07=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME07}.py
# CONFIG_FILE08=./configs/_scratch_/architecture/3-3-3-3/${CONFIG_NAME08}.py
