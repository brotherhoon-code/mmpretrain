...
CONFIG_FILE02=./configs/_scratch_/architecture/in20/${CONFIG_NAME02}.py
CONFIG_FILE03=./configs/_scratch_/architecture/in20/${CONFIG_NAME03}.py
CONFIG_FILE04=./configs/_scratch_/architecture/in20/${CONFIG_NAME04}.py
CONFIG_FILE05=./configs/_scratch_/architecture/in20/${CONFIG_NAME05}.py
CONFIG_FILE06=./configs/_scratch_/architecture/in20/${CONFIG_NAME06}.py
CONFIG_FILE07=./configs/_scratch_/architecture/in20/${CONFIG_NAME07}.py
CONFIG_FILE08=./configs/_scratch_/architecture/in20/${CONFIG_NAME08}.py
